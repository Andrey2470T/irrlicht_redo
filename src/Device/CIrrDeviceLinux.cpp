...
#else
		g_irrlogger->log("No OpenGL-ES1 support compiled in.", ELL_ERROR);
#endif
	break;
...
#else
		g_irrlogger->log("No OpenGL-ES2 support compiled in.", ELL_ERROR);
#endif
	break;
...
#else
		g_irrlogger->log("No WebGL1 support compiled in.", ELL_ERROR);
#endif
	break;
	case video::EDT_NULL:
